...
func (Tile_GeomType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_vector_tile_3adafffe2f30d7e8, []int{0, 0}
}
...
func (*Tile) Descriptor() ([]byte, []int) {
	return fileDescriptor_vector_tile_3adafffe2f30d7e8, []int{0}
}
...
func (dst *Tile_Value) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Tile_Value.Merge(dst, src)
}
...
func (*Tile_Feature) Descriptor() ([]byte, []int) {
	return fileDescriptor_vector_tile_3adafffe2f30d7e8, []int{0, 1}
}
...
func (dst *Tile_Feature) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Tile_Feature.Merge(dst, src)
}
...
func (*Tile_Layer) Descriptor() ([]byte, []int) {
	return fileDescriptor_vector_tile_3adafffe2f30d7e8, []int{0, 2}
}
...
func (dst *Tile_Layer) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Tile_Layer.Merge(dst, src)
}
...
func init() { proto.RegisterFile("vector_tile.proto", fileDescriptor_vector_tile_3adafffe2f30d7e8) }

var fileDescriptor_vector_tile_3adafffe2f30d7e8 = []byte{
